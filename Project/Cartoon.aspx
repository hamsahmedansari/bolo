<%@ Page Title="" Language="C#" MasterPageFile="~/UserChild.master" AutoEventWireup="true" CodeBehind="Cartoon.aspx.cs" Inherits="Bolo.Cartoon" %>
        ...
        <div class="row" style="width:100%; margin-left:0.2%;">
           <div class="col-sm-12">
               <div class="plioo" style="border: 0px; margin-left: 0px; padding: 0px; width: 100% !important;    box-shadow: none !important;">
                   <asp:Panel ID="PanelAllCartoons" runat="server" Visible="false">
                       ...
                       <div class="text-center">
                           <asp:ListView runat="server" ID="lvCartoonListPreview" GroupItemCount="3" DataKeyNames="pkMovieID" OnPagePropertiesChanging="lvCartoonListPreview_PagePropertiesChanging">
                               <LayoutTemplate>
                               ...
                               <ItemTemplate>
                                   <a href='<%#"Cartoon.aspx?ID=" + Eval("pkMovieID") %>' rel="bookmark" class="post-thumbnail tie-appear"> 
                                       <div class="qwdertyji" style="overflow:hidden;width:150px;">
                                           <div style="width:100%;max-width:200px;position:relative;overflow:hidden">
                                               <asp:Image runat="server" ID="ProductImage" src='<%#"Images/Movies/" + Eval("txtMovieImage") %>' AlternateText="Alternate Text"  style="width:100%;max-width:200px; height:100%;max-height:200px" />
                                           ...
                                           <div class="row text-left container-fluid text-primary">
                                               <span style="font-size:15px;text-align:left"><%#Eval("varMovieName")%></span>
                   ...
                   <asp:Panel ID="pnlCartoonDetail" runat="server">
                       <div class="row text-center">
                           ...
                           <div class="row">
                               <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-xs-12 col-12">
                                   ...
                                   <asp:Image runat="server" ID="imgPoster" ImageUrl="../img/Hollow.in.the.Land-1512812350417.jpg" class="img img-responsive" alt="Alternate Text" style="width:400px;display:inline-block"/>
                                ...
                                <div id="change_img_2000" class="modal fade" role="dialog" style="display: none;">
                                    <div class="modal-dialog">
                                       ...
                                       <div class="row">
                                           ...
                                           <div class="col-xl-7 col-lg-7 col-md-6 col-sm-6 col-xs-6 col-6 text-left" style="padding-left:20px;">
                                               <p runat="server" id="pGenere">sdasd</p>
                                           </div>

                                       </div>
                                   </div>
                                   <div class="row" style="font-size:14px;">
                                       <div class="col-xl-3 col-lg-3 col-md-4 col-sm-4 col-xs-4 col-4" style="text-align:left;padding-left: 43px;">
                                           <b class="text-dark">
                                               Release Date
                                           </b>
                                       </div>
                                       ...
                                       <div class="col-xl-7 col-lg-7 col-md-6 col-sm-6 col-xs-6 col-6 text-left" style="padding-left:20px;">
                                           <p runat="server" id="pReleaseDate">Date</p>
                                       </div>
                                   </div>
                                   <div class="row">
                                       <div class="col-xl-3 col-lg-3 col-md-4 col-sm-4 col-xs-4 col-4" style="text-align:left; padding-left:43px;">
                                           <b class="text-dark">Cast</b>
                                       </div>
                                       <div class="col-xl-1 col-lg-1 col-md-1 col-sm-1 col-xs-1 col-1">
                                           
                                       </div>
                                       <div class="col-xl7 col-lg-7 col-md-6 col-sm-6 col-xs-6 col-6 text-left" style="padding-left:20px;">
                                           <p runat="server" id="pCast">Cast</p>
                                       </div>
                                   </div>
                                   <div class="row">
                                       <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 col-12 opopopopliopo">
                                           <b class="text-dark text-center" style="text-align:left;padding-left:16px;">StoryLine</b>
                                       </div>
                           ...
                           <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 col-12" style="padding:50px;">
                               <div class="form-group">
                                   ...
                                   <div class="input-group" style="margin-bottom:10px;">
                                       ...
                                       <asp:TextBox ID="txtName" runat="server" CssClass="form-control" plceholder="Name" MaxLength="150" required type="text"></asp:TextBox>
                                   </div>
                                   <div class="input-group" style="margin-bottom:10px;">
