<%@ Page Title="" Language="C#" MasterPageFile="~/UserChild.master" AutoEventWireup="true" CodeBehind="BloodDonation.aspx.cs" Inherits="Bolo.BloodDonation" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="OtherContent" runat="server">
    ...
    border: 1px solid #ccc;">
                <div class="row text-center">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 col-12 bg-primary">
                        <div class="row container-fluid">
                            <h3>
                                Blood Donor's in Your Area
                            </h3>
                        </div>
                        <div class="row container-fluid">
                            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-xs-4 col-4">
                                <p>City</p>
                                <asp:DropDownList ID="DropDownListCityMain" runat="server" CssClass="form-control">
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-xs-4 col-4">
                              ...
                              <asp:TextBox runat="server" name="areaSearch" ID="txtareaSearch" class="form-control"></asp:TextBox>
                            </div>
                            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-xs-4 col-4">
                                <p>
                                    Blood Group
                                </p>
                               <asp:DropDownList ID="DropDownListBloodGroupMain" runat="server" CssClass="form-control">
                                 <asp:ListItem Value="-1">-- Select --</asp:ListItem>
                        ...
                        <div class="row" style="margin-top:10px;margin-bottom:10px;">
                            <button type="button" class="btn btn-lg btn-danger"  onserverclick="btn_searchClick" runat="server">
                                <span class="fa fa-ambulance">
                                </span>
                                Search Donar Now
                            </button>
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin-top:10px;">
                            <asp:GridView  ID="dgvBloodDonation" runat="server" AllowPaging="True" CellPadding="4" GridLines="None" ForeColor="#333333" Width="100%" 
                                CellSpacing="3" AutoGenerateColumns="False"  ShowHeaderWhenEmpty="True" OnPageIndexChanging="dgvBloodDonation_PageIndexChanging">
                                <AlternatingRowStyle BackColor="Gainsboro" BorderWidth="0px" BorderStyle="Solid"/>
                                 <Columns>
                    <asp:BoundField DataField="varName" HeaderText="Donor Name" ReadOnly="true" SortExpression="BloodDonation" ItemStyle-Width="150">
...
<ItemStyle Width="150px"></ItemStyle>
                    ...
                    <asp:BoundField DataField="varCity" HeaderText="Donar City" ReadOnly="true" ItemStyle-Width="150px">
                         <HeaderStyle CssClass="text-center" />
<ItemStyle Width="150px"></ItemStyle>
                    </asp:BoundField>
                    <asp:TemplateField HeaderText="Contact" ItemStyle-CssClass="text-center">
                <ItemTemplate>
                    <button ID="btnSelect" runat="server" data-toggle="modal" data-target="#myModal" CausesValidation="False" Height="35"
                     UseSubmitBehavior="False" Width="75" class="btn btn-default"><span class="fa fa-mobile-phone"></span></button>
                    <!-- The Modal -->
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h4 class="modal-title">Bolo Blood Donation System</h4>
        <button type="button" class="close" data-dismiss="modal">&times;</button>
      </div>

      <!-- Modal body -->
      <div class="modal-body">
        Please contact us in order to recieve this blood.
      </div>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                ...
                <HeaderStyle CssClass="text-center" />
<ItemStyle HorizontalAlign="Right" CssClass="text-center"></ItemStyle>
            </asp:TemplateField>  
                    </Columns>
                     
                    <FooterStyle BackColor="#507CD1" Font-Bold="True" ForeColor="White" />
                    <RowStyle BackColor="#EFF3FB" Height="40px" HorizontalAlign="Center" />
                    <EditRowStyle BackColor="#2461BF" />
                    <SelectedRowStyle BackColor="#D1DDF1" Font-Bold="True" ForeColor="#333333" />
                    <PagerStyle BackColor="#2461BF" ForeColor="White" HorizontalAlign="Center" />
                    <HeaderStyle BackColor="#507CD1" Font-Bold="True" ForeColor="White" Height="50px" Font-Size="Large" />
                    <AlternatingRowStyle BackColor="White" ForeColor="#284775" Height="40px" />
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 col-12 bg-primary" style="margin-top:20px;">
                    <div class="row container-fluid text-center">
                        ...
                        <div class="form-group">
                            <label>Name</label>
                            <asp:TextBox ID="txtDonarName" runat="server" CssClass="form-control"></asp:TextBox>
                        </div>
                        <div class="form-group">
                            <label>City</label>
                        ...
                        <div class="form-group">
                            ...
                            <asp:TextBox runat="server" name="Area" ID="txtArea" class="form-control"></asp:TextBox>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <asp:DropDownList ID="DropDownListBlooadGroup" runat="server" CssClass="form-control">
                                 <asp:ListItem Value="-1">-- Select --</asp:ListItem>
                               <asp:ListItem >A+</asp:ListItem>
                                <asp:ListItem >A-</asp:ListItem>
                                <asp:ListItem >AB+</asp:ListItem>
                        ...
                        <div class="form-group">
                            <label>Suitable Time For Donation</label>
                            <input id="dteSelectDate" type="date" runat="server" class="form-control" min="2017-01-02" max="3000-01-02"/>
                        </div>
