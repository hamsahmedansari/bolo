<%@ Page Title="" Language="C#" MasterPageFile="~/UserChild.master" AutoEventWireup="true" CodeBehind="Movies.aspx.cs" Inherits="Bolo.Movies" %>
    ...
    <div class="row" style="width: 100%; margin-left: 0.2%;">
     <div class="col-sm-12">
       <div class="plioo" style="border: 0px; margin-left: 0px; padding: 0px; width: 100% !important;box-shadow: none !important;">
          <asp:Panel ID="pnlAllMovie" runat="server" Visible="false">    
       ...
       <asp:Button ID="btnViewAll" Style="float: right" UseSubmitBehavior="false" Text="View All" class="btn btn-primary" runat="server" OnClick="btnViewAll_Click" />
        ...
        <asp:ListView runat="server" ID="lvMovieListPreview" GroupItemCount="3" DataKeyNames="pkMovieID" OnPagePropertiesChanging="lvMovieListPreview_PagePropertiesChanging">
            <LayoutTemplate>
            ...
            <ItemTemplate>
    <a href='<%#"Movies.aspx?ID=" + Eval("pkMovieID") %>' rel="bookmark" class="post-thumbnail tie-appear">
        <div class="qwdertyji" style="overflow:hidden;width: 150px;">
            <div style="width:100%; max-width:200px;position:relative;overflow:hidden">
                <asp:Image runat="server" ID="ProductImage" src='<%# "Images/Movies/" + Eval("txtMovieImage") %>' alt="Alternate Text" class="img img-fluid" style="
    width: 100%;
    max-width: 200px;
...
"/>
        ...
        <div class="row text-left container-fluid text-primary">
            <span style="font-size:14px;text-align:left"><%#Eval("varMovieName")%></span>
                                               <p style="text-align:left; font-size:10px;">
                                                   <b>Likes</b> <span><%# Eval("intLikesCounter") %></span><br />
                                                   <b>Downloads</b> <span><%# Eval("intDownloadsCounter") %></span>
       <%-- <span style="font-size:30px;text-align:left"><b>Tittle</b></span>
        ...
        <b>Downloads</b> <span><%# Eval("intDownloadsCounter") %></span>
           ...
           <!--Post Page Code-->
    <asp:Panel ID="pnlMovieDetail" runat="server" Visible="true">
       <div class=" text-center">
                    ...
                    <div class="row">
                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-xs-12 col-12">
                            <!--Movie Banner Image-->
                                <asp:Image runat="server" ID="imgPoster" Imageurl="../img/Hollow.in.the.Land-15128123504217.jpg" class="img img-responsive" alt="Alternate Text" style="width:400px;display:inline-block;margin-bottom:10px;"/>
                        </div>
    ...
    height: 60px;">
                                ...
                                <div class="row">
                                    <div class="col-xl-3 col-lg-3 col-md-4 col-sm-4 col-xs-4 col-4" style="
    text-align:  left;
    padding-left: 53px;
">
                                        <b class="text-dark ">
...
">
                                ...
                                <div class="row">
                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 col-12 opopopopliopo">
                                        <b class="text-dark  text-center" style="
    text-align:  left;
    padding-left: 16px;
">
                                            StoryLine
                                    ...
                                    <div class="col-xl-12 col-lg-12  col-md-12 col-sm-12 col-xs-12 col-12 text-left">
                                        <!--Movie Details-->
                                        <p runat="server" id="pDetails" class="opopoplopopoplo" style="
        text-align: justify;
    padding: 5px;
    margin-left: 34px;
    margin-right: 21px;
